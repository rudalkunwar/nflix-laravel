...
@section('content')
    ...
    <div class="bg-white p-4 rounded-md shadow-md flex justify-center items-center">
        <div class="flex-1 max-w-3xl p-8 m-4 shadow-md bg-white rounded-lg">
            <h4 class="text-2xl font-semibold text-blue-gray-800 mb-4 text-center">Edit Genre</h4>
            <form action="{{ route('admin.genres.update', $genre->id) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="description" id="description" rows="4"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50">{{ $genre->description }} </textarea>
                </div>
