...
@section('content')
    <div class="bg-white p-4 rounded-md shadow-md mb-6 flex justify-between items-center">
        <h2 class="text-2xl font-bold text-gray-800">Edit director</h2>
    ...
    <div class="bg-white p-6 rounded-md shadow-md flex justify-center items-center">
        <div class="flex-1 max-w-3xl bg-gray-50 p-8 rounded-lg shadow-lg">
            <h4 class="text-3xl font-bold text-gray-900 mb-6 text-center">Edti director</h4>
            <form action="{{ route('admin.directors.update', $director->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="name" id="name" value="{{ $director->name }}" required
